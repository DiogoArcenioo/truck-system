...
const moduloMetadata: Record<ModuloSistema, Omit<ModuloMetadata, 'id'>> = {
  ...
  cte: {
    label: 'CT-e',
    descricao: 'Cadastro e consulta de conhecimentos de transporte eletronicos.',
  },
  manifestos: {
    label: 'Manifesto',
    descricao: 'Cadastro e controle de MDF-e (manifesto de documentos fiscais).',
  },
  abastecimentos: {
